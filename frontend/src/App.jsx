  ...
  return (
    <Router>
      <Routes>
        ...
        {/* Canonical link generated by the backend offer email notification. */}
        <Route path="/offers/public/:token" element={<CandidateOfferSignPage />} />
        {/* Keep the earlier frontend link valid for already-sent offers. */}
