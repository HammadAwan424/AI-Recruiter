...
def seed_interviews(db, users_context, applications):
    ...
    # 1. Interview Round for Application #3 (Marcus Vance - Stage: Interview, Job 1)
    ...
    # 2. Historical Interview Round for Offer Approval Candidate (Elena Rostova - Job 1, App 4)
    ...
    # 3. Historical Interview Round for Hired Candidate (Olivia Taylor - Job 1, App 6)
